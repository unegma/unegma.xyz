...
Crypto and NFTs are a big experiment built on top of this technology, a technology which *[provides a blueprint on which anything - to which Ownership can be applied - can be built digitally][blockchain-revolution]*. 
