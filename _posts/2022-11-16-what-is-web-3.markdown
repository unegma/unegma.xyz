...
Ownership requires three things to be legitimate: 1. an official record of Possession: i.e. a definitive list of who owns what, and 2. Transferability: i.e, the ability for one party to pass on, something they own, to someone else; with the possibility for it to be passed back.
