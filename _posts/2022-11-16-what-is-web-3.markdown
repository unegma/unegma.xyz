...
Crypto and NFTs are a big experiment built on top of this new technology; *a technology which, essentially, [provides a blueprint on which anything - to which Ownership can be applied - can be built digitally][blockchain-revolution]*. 
